...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
      ...
      KC_LSFT, KC_SLSH,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_RSFT,  KC_NO, KC_UP,    MO(1),
      KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                          KC_RCTL, KC_RALT,    KC_LEFT, KC_DOWN,  KC_RIGHT),
